  ...
  <body>
    ...
    <main>
        ...
        <div class="container mt-5" align="center">
            <h1 class="fs-2">TERMS AND CONDITIONS</h1>
            <hr style="width:50%;">
        </div>
        ...
        <div class="container" style="width:90%;">
          <div class="row">
            <div class="col-lg-12">
              <ol>
                    <li style="list-style-type:decimal;">Pay as you Ckeck-in and Strictly</li>
                    <li style="list-style-type:decimal;">Pay as you Order - Please pay food bill.</li>
                    <li style="list-style-type:decimal;">Head Counts is being implemented.</li>
