      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <div class="navbar-nav">
            ...
            <a href="default-about-us.php" class="nav-item page-header nav-link">About Us</a>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-sm-12 ps-5">
            ...
            <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                ...
                <h5><i class="fa-solid fa-circle-chevron-right fa-md" style="color: #aa2400;"></i> One Person Company</h5>
                <h5><i class="fa-solid fa-circle-chevron-right fa-md" style="color: #aa2400;"></i> Partnered with Reddoorz</h5>
                <h5><i class="fa-solid fa-circle-chevron-right fa-md" style="color: #aa2400;"></i> Di q alam</h5>
                <h5><i class="fa-solid fa-circle-chevron-right fa-md" style="color: #aa2400;"></i> ewan</h5>
