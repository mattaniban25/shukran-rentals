  ...
  <div class="header">
    ...
    <div id="carouselExampleCaptions" class="carousel" data-bs-ride="carousel">
          ...
          <div class="welcome-div" align="center">
                <p class="welcome-message h4 fs-4 mt-5 mb-3 fw-bold">PLAN YOUR NEXT EVENT WITH US!</h4>
                  <div class="welcome-description mb-5 col-lg-6 col-md-6 col-sm-12">
                    <p align="justify" class="fs-5">Experience churvanes in our Unfussy budget hotel located in an accessible and strategic place in the locality of Paranque City.
